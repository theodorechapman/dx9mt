...
<table>
<tr>
<td align="center" width="50%"><b>Actual FNV Main Menu</b></td>
<td align="center" width="50%"><b>Our Current Output</b></td>
</tr>
<tr>
<td><img src="assets/fnv_main_menu_actual.jpg" width="100%"></td>
<td><img src="assets/current_state.png" width="100%"></td>
</tr>
</table>
...
- D3D9 SM2.0/SM3.0 shader bytecode translated to MSL in real time
- Shader and PSO compilation cached by bytecode hash
- Depth testing with per-RT Depth32Float textures and MTLDepthStencilState cache
- Full D3D9 fixed-function TSS combiner in Metal fragment shader
...
| RB3 Phase 2 | Done | Textures, sampler state, TSS combiners, blend, alpha test, render-target routing |
...
Press 'D' in the viewer window to write per-draw state to `/tmp/dx9mt_frame_dump.txt`. Shows per-draw: primitive type/count, vertex format, texture info, TSS state, blend state, depth/stencil state, sampler state, viewport, shader bytecode info, and vertex data samples.
